...
Teamname = pd.read_excel('T20_Cricket_players.xlsx', header=[0, 1])
...
for i in players:
    ...
    driver.get(
        "http://www.cricmetric.com/playerstats.py?player={}&role=all&format=T20I&groupby=match&playerStatsFilters=on&start_date=2015-01-01&end_date=2024-10-07&start_over=0&end_over=9999".format(
            i.replace(' ', '+')))
    # driver.get("http://www.cricmetric.com/playerstats.py?player={}&role=all&format=TWENTY20&groupby=match&playerStatsFilters=on&start_date=2018-01-01&end_date=2023-10-07&start_over=0&end_over=9999".format(i.replace(' ', '+')))
    ...
    try:
        ...
        bowling_tab = driver.find_element(By.XPATH, '//*[@id="T20I-Bowling-tab"]')
        bowling_tab.click()
        time.sleep(2)
...
final_data.to_excel('T20_data_scrapped.xlsx', index=False)
