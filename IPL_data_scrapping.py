...
Teamname = pd.read_excel('IPL_Cricket_players.xlsx', header=[0, 1])
...
for i in players:
    ...
    if i != 'MAYANK YADAV' and i != 'SUYASH SHARMA' and i !='PRASHANT SOLANKI' and i != 'AKASH MADHWAL' and i != 'HIMANSHU SHARMA' and i != 'RAJAN KUMAR' and i != 'NITISH KUMAR REDDY' and i != 'RAJVARDHAN HANGARGEKAR':
        ...
        try:
            ...
            batting_table = driver.find_element(By.XPATH, '/html/body/div[1]/div/div[1]/div[2]/div[2]/div/div[1]/div')
            ...
            bowling_tab = driver.find_element(By.XPATH, '/html/body/div[1]/div/div[1]/div[2]/div[2]/ul/li[2]/a')
            bowling_tab.click()
            time.sleep(1)

            # Extracting bowling stats of the player
            bowling_table = driver.find_element(By.XPATH,
                                                '/html/body/div[1]/div/div[1]/div[2]/div[2]/div/div[2]/div/table')
...
final_data.to_excel('IPL_data_scrapped.xlsx', index=False)
